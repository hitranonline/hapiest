...
HITRAN_DEFAULT_HEADER = {
    ...
    "description":    {
        ...
        "local_upper_quanta":  "Rotational, hyperfine and other quantum numbers and labels for "
                               "the upper state of a transition",
...
PARAMETER_META = \
    {
        ...
        "sw":                  {
            ...
            "name_html":        "<em>S</em>",
            "table_name":       "prm_sw",
            "description":      "Line intensity, multiplied by isotopologue abundance, at T = 296 "
                                "K",
            "description_html": "Line intensity, multiplied by isotopologue abundance, "
                                "at T&nbsp;=&nbsp;296&nbsp;K",
            "default_fmt":      "%10.3e",
        ...
        "global_upper_quanta": {
            ...
            "table_name":       "",
            "description":      "Electronic and vibrational quantum numbers and labels for the "
                                "upper state of a transition",
            "description_html": "Electronic and vibrational quantum numbers and labels for the "
                                "upper state of a transition",
            "default_fmt":      "%15s",
            "default_units":    None,
            "data_type":        "str",
        ...
        "local_upper_quanta":  {
            ...
            "table_name":       "",
            "description":      "Rotational, hyperfine and other quantum numbers and labels for "
                                "the upper state of a transition",
            "description_html": "Rotational, hyperfine and other quantum numbers and labels for "
                                "the upper state of a transition",
            "default_fmt":      "%15s",
            "default_units":    None,
            "data_type":        "str",
        ...
        "line_mixing_flag":    {
            ...
            "table_name":       "",
            "description":      "A flag indicating the presence of additional data and code "
                                "relating to line-mixing",
            "description_html": "A flag indicating the presence of additional data and code "
                                "relating to line-mixing",
            "default_fmt":      "%1s",
            "default_units":    "",
            "data_type":        "str",
        ...
        "ierr":                {
            ...
            "table_name":       "",
            "description":      "Ordered list of indices corresponding to uncertainty estimates "
                                "of transition parameters",
            "description_html": "Ordered list of indices corresponding to uncertainty estimates "
                                "of transition parameters",
            "default_fmt":      "%s",
            "default_units":    "",
            "data_type":        "str",
        ...
        "deltap_air":          {
            ...
            "description":      "Linear temperature dependence coefficient for air-induced "
                                "pressure shift",
            "description_html": "Linear temperature dependence coefficient for air-induced "
                                "pressure shift",
            "default_fmt":      "%10.3e",
            "default_units":    "",
            "data_type":        "float",
        ...
        "deltap_self":         {
            ...
            "description":      "Linear temperature dependence coefficient for self-induced "
                                "pressure shift",
            "description_html": "Linear temperature dependence coefficient for self-induced "
                                "pressure shift",
            "default_fmt":      "%10.3e",
            "default_units":    "",
            "data_type":        "float",
        ...
        "y_self":              {
            ...
            "description":      "First-order (Rosenkranz) line coupling coefficient; "
                                "self-broadened environment",
            "description_html": "First-order (Rosenkranz) line coupling coefficient; "
                                "self-broadened environment",
            "default_fmt":      "%10.3e",
            "default_units":    "cm-1.atm-1",
            "data_type":        "float",
        ...
        "beta_g_self":         {
            ...
            "description":      "Dicke narrowing parameter for the self-broadened Galatry line "
                                "profile",
            "description_html": "Dicke narrowing parameter for the self-broadened Galatry line "
                                "profile",
            "default_fmt":      "%9.6f",
            "default_units":    "",
            "data_type":        "float",
        ...
        "gamma_H2":            {
            ...
            "description":      "Lorentzian lineshape HWHM due to pressure broadening by H2 at 1 "
                                "atm pressure",
            "description_html": "Lorentzian lineshape HWHM due to pressure broadening by "
                                "H<sub>2</sub> at 1&nbsp;atm pressure",
            "default_fmt":      "%6.4f",
            "default_units":    "cm-1.atm-1",
            "data_type":        "float",
            "selectable":       1,
        ...
        "delta_H2":            {
            ...
            "description_html": "Pressure shift induced by H<sub>2</sub>, referred to "
                                "<em>p</em>=1&nbsp;atm",
            "default_fmt":      "%9.6f",
            "default_units":    "cm-1.atm-1",
            "data_type":        "float",
        ...
        "deltap_H2":           {
            ...
            "description":      "Linear temperature dependence coefficient for H2-induced "
                                "pressure shift",
            "description_html": "Linear temperature dependence coefficient for "
        ...
        "gamma_He":            {
            ...
            "description":      "Lorentzian lineshape HWHM due to pressure broadening by He at 1 "
                                "atm pressure",
            "description_html": "Lorentzian lineshape HWHM due to pressure broadening by He at "
                                "1&nbsp;atm pressure",
            "default_fmt":      "%6.4f",
            "default_units":    "cm-1.atm-1",
            "data_type":        "float",
        ...
        "gamma_CO2":           {
            ...
            "description":      "Lorentzian lineshape HWHM due to pressure broadening by CO2 at 1"
                                " atm pressure",
            "description_html": "Lorentzian lineshape HWHM due to pressure broadening by "
        ...
        "delta_CO2":           {
            ...
            "description_html": "Pressure shift induced by CO<sub>2</sub>, referred to "
                                "<em>p</em>=1&nbsp;atm",
            "default_fmt":      "%9.6f",
            "default_units":    "cm-1.atm-1",
            "data_type":        "float",
...
def prepareHeader(parlist):
    HEADER = {
        'table_name':    '', 'number_of_rows': -1, 'format': { },
...
def print_iso_id():
    print(
        'The dictionary \"ISO_ID\" contains information on \"global\" IDs of isotopologues in '
        'HITRAN\n')
    print(
...
tt = __FloatType__(
        [0.5e0, 1.5e0, 2.5e0, 3.5e0, 4.5e0, 5.5e0, 6.5e0, 7.5e0, 8.5e0, 9.5e0, 10.5e0, 11.5e0,
         12.5e0, 13.5e0, 14.5e0])
...
def pcqsdhc(sg0, GamD, Gam0, Gam2, Shift0, Shift2, anuVC, eta, sg):
    ...
    if abs(c2t) == 0.0e0:
        ...
        if any(index_PART4):
            ...
            Bterm = (-1.0e0 +
                     rpi / (2.0e0 * csqrtY) * (1.0e0 - Z1 ** 2) * __ComplexType__(
                        WR1_PART4 + 1.0e0j * WI1_PART4) -
                     rpi / (2.0e0 * csqrtY) * (1.0e0 - Z2 ** 2) * __ComplexType__(
        ...
        if any(index_PART3):
            ...
            if any(index_ABS):
                ...
                Bterm[index_ABS] = (1.0e0 / c2t) * (-1.0e0 +
                                                    2.0e0 * rpi * (1.0e0 - X_TMP[
                            index_ABS] - 2.0e0 * Y) * (1.0e0 / rpi - sqrt(
                                X_TMP[index_ABS]) * __ComplexType__(WRb + 1.0e0j * WIb)) +
                                                    2.0e0 * rpi * sqrt(
            ...
            for species in Diluent:
                ...
                try:
                    ...
                    try:
                        ...
                        if VARIABLES['DEBUG']:
                            print(
                                'absorptionCoefficient_HT: Gamma0DB=%f (not found in database)' % Gamma0DB)

                # Search for temperature exponent for broadening HWHM.
                try:
                    # search for HT-style name
                    TempRatioPowerDB = \
                    LOCAL_TABLE_CACHE[TableName]['data']['n_HT_%s_%d' % (species_lower, TrefHT)][
                        RowID]
                    ...
                    try:
                        ...
                        if VARIABLES['DEBUG']:
                            print(
                                'absorptionCoefficient_HT: TempRatioPowerDB=%f (found as n_air). Tref is set to 296K.' % TempRatioPowerDB)
                ...
                try:
                    ...
                    try:
                        ...
                        if VARIABLES['DEBUG']:
                            print(
                                'absorptionCoefficient_HT: Shift0DB=%f (not found in database)' % Shift0DB)
                ...
                try:
                    ...
                    try:
                        ...
                        if VARIABLES['DEBUG']:
                            print(
                                'absorptionCoefficient_HT: deltap=%f (not found in database)' % deltap)
                ...
                try:
                    ...
                    try:
                        ...
                        if VARIABLES['DEBUG']:
                            print(
                                'absorptionCoefficient_HT: Gamma2DB=%f (not found in database)' % Gamma2DB)
                ...
                try:
                    ...
                    if VARIABLES['DEBUG']:
                        print(
                            'absorptionCoefficient_HT: Shift2DB=%f (not found in database)' % Shift2DB)
                ...
                try:
                    ...
                    if VARIABLES['DEBUG']:
                        print(
                            'absorptionCoefficient_HT: KappaDB=%f (not found in database)' % KappaDB)
